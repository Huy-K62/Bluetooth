...
QT_MOC_LITERAL(1, 13, 20), // "Receive_wifi_success"
QT_MOC_LITERAL(2, 34, 0) // ""

    },
    "ServerSocket\0Receive_wifi_success\0"
};
...
void ServerSocket::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->Receive_wifi_success(); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&ServerSocket::Receive_wifi_success)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void ServerSocket::Receive_wifi_success()
{
